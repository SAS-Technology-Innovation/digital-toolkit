...
- Grade Levels: K-5, 6-8, 9-12, or K-12
```
...
The enrichment tools expect these column headers (case-sensitive):
...
| `subjects_or_department` | String | No | No |
| `Enterprise` | Boolean | No | No |
| `budget` | Number | No | No |
| `audience` | String | No | **Yes** |
| `License Type` | String | No | No |
...
**Enrichable Fields:** These can be auto-generated by Claude AI
- `description` - App description (1-2 sentences)
- `Category` - App category
- `audience` - Target users
- `grade_levels` - Grade level ranges
...
2. Check column headers match expected names (case-sensitive)
